...
GPKG_PATH = os.path.join(SCRIPT_DIR, "../../data/03_interim/highway_traffic.gpkg")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "../../data/plots/highway_traffic_maps")
...
for layer in layers:
    ...
    ax = gdf_wm.plot(
        ax=ax, 
        column='avg_tmdm_2024', 
        cmap='RdYlGn_r', 
        linewidth=4, 
        legend=True,
        legend_kwds={'label': "Average Daily Traffic (2024)", 'orientation': "vertical", 'shrink': 0.6}
    )
